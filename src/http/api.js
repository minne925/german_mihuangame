export default {
    ...
    'sys_get_BeneficiaryBank': '/system/getBeneficiaryBankList', //获取收款银行列表
    'sys_get_BeneficiaryBankInfo': '/system/getBeneficiaryBankInfo', //获取收款银行详情
	'video_class': '/video/itemlist', //视频分类
	'video_get_info': '/video/getVideoInfo', //视频分类
	'video_get_more_item': '/video/getVideoInfoItem', //获取视频列表下的更多视频蜜桃源码网--www.mitaobo.com
    ...
    'user_get_recharge_list': '/member/getUserRechargeList', //获取充值提现记录
	'user_get_game_list': '/member/getUserGameList', //获取用户提现记录
	'user_set_bank': '/member/setBank', //更新用户银行卡
	'user_set_bank1': '/member/setBank1', //更新用户银行卡新
	...
	'address_list': '/xuanfei/address', //选妃地址蜜桃源码网--www.mitaobo.com
	'xuanfeilist': '/xuanfei/xuanfeilist', //选妃列表
    'xuanfeidata': '/xuanfei/xuanfeidata', //选妃详情
    'xuanfeilike': '/xuanfei/xuanfeilike', //选妃详情
    'getTopList': '/xuanfei/getTopList', //选妃详情


    'pay-upload': '/member/recharge', //充值
    'sys_get_notice_num': '/notice/getNoticeNum', //获取未读公告
    'get_news': '/news/getNews', //获取栏目详细内容
    'sys_get_lang': '/system/getLang', //获取语言
    'member_passpay': '/member/passpay', //提现密码
    'resetPayPassword': '/member/resetPayPassword', //获取语言
