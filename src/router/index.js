...
import Withdraw from '../pages/mine/Withdraw'/* 提现界面 */
import Recharge from '../pages/mine/Recharge'/* 充值界面 */
...
import Pay from '../pages/mine/Pay'/* 充值 */
import News from '../pages/news'/* 栏目 */
import Details from '../pages/choose/details'
import ConfirmPassword from '../pages/mine/ConfirmPassword'
...
const routes = [
    ...
    { path: '/RechargeRecord', name: 'RechargeRecord', component: RechargeRecord, meta: { title: '充值记录' } },
    { path: '/Pay', name: 'Pay', component: Pay, meta: { title: '充值' } },
    { path: '/News', name: 'News', component: News, meta: { title: '栏目详细内容' } },
    { path: '/Details', name: 'Details', component: Details, meta: { title: '详情' } },
    {
        path: '/Trade',
        name: 'trade',
        meta: { title: '行情' },
        component: () => import('../pages/contract/Trade.vue')
    },
    {
        path: '/Contract/index',
        name: 'Contract_index',
    ...
    {
        path: '/Contract/cbillinfo',
        name: 'cbillinfo',
        component: () => import('../pages/contract/Cbillinfo.vue'),
    },

    {
        path: '/Contract/ctbill',
        name: 'ctbill',
        component: () => import('../pages/contract/Ctbill.vue'),
    },

    {
        path: '/confirmPassword',
        name: 'confirmPassword',
        component: () => import('../pages/mine/ConfirmPassword.vue'),
    },
    {
        path: '/resetPayPassword',
        name: 'resetPayPassword',
        component: () => import('../pages/mine/ResetPayPassword.vue'),
    },
    {
        path: '/guide1',
        name: 'guide1',
        component: () => import('../pages/guide/index1.vue')
    },
    {
        path: '/guide2',
        name: 'guide2',
        component: () => import('../pages/guide/index2.vue')
    },
    {
        path: '/guide3',
        name: 'guide3',
...
router.beforeEach((to, from, next) => {         //修改标题路由配置加上这个
    ...
    document.title = 'Titelseite'
    // document.title = to.matched[0].meta.title
    // document.title = 'lauxanh-us'
    // console.log(to,from)
