<template>
    <div class="container-fluid">
        <div class="titlebox">
            <div style="width:100%;">
                <!-- <span class="txt_style">{{ $t('USDT市场') }}</span> -->
                <!-- <span class="txt_style"> 認証センター</span> -->
                ...
                <router-link
                    ...
                    <div style="width:100%;height:50px;">
                        <div class="list_cname">
                            <span class="f32 b5 bcolor">
                                {{ cover(vo.cname)  }}
                            </span>
                        </div>
                        <div class="list_open ">
                            <span class='fzmmm fcc'>
                                <span class='f32 fgreen b5'
                        ...
                        <div class="list_change">
                            <span class='f14 b5 bgreen market-list-info'
                                v-if="curmarkets[vo.coinname]?.data?.tick?.close > curmarkets[vo.coinname]?.data?.tick?.open">
                                {{ fd(curmarkets[vo.coinname]?.data) }}</span>
                            <span class='f14 b5 bred market-list-info' v-else>
...
import { isEmpty,covertCoin } from "@/utils/tools";
...
.txt_style {
    ...
    height: 60px;
    line-height: 60px;
    // border-bottom: 6px solid #3db485;
    color: #000;
    font-weight: bold;
    font-size: 40px;
